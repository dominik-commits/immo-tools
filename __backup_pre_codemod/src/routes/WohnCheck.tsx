      ...
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-6">
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            <Metric label="DSCR" value={viewOut.dscr ? viewOut.dscr.toFixed(2) : "–"} hint="NOI / Schuldienst (â≥1,2 üblich)." />
          </div>
          ...
          <div className="rounded-[var(--radius)] border p-4 bg-card shadow-soft">
            ...
            <div className="space-y-4">
              ...
              <SliderRow
                ...
                right={`${signedPct(rentAdjPct)} â†’ ${adjustedRentPerM2.toFixed(2)} €/m²`}
