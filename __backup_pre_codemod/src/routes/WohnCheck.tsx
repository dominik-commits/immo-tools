      ...
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-6">
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-[var(--radius)] border p-4 bg-card shadow-soft space-y-6">
            ...
            <div className="grid grid-cols-1 gap-3">
              <InfoTile title="VermÃ¶genszuwachs p.a. (ohne Wertsteigerung)" value={eur(Math.round(equityGainNoApp))} subtle />
              <InfoTile title="VermÃ¶genszuwachs p.a. (mit Wertsteigerung)" value={eur(Math.round(equityGainWithApp))} subtle />
            </div>
              ...
              <div className="h-56">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={projection} margin={{ top: 10, right: 12, left: 0, bottom: 0 }}>
                    ...
                    <Line type="monotone" dataKey="vermoegenPA" name="VermÃ¶genszuwachs p.a." stroke={ORANGE} strokeWidth={2} dot={false} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
  ...
  return (
    <div className="mt-4 rounded-[var(--radius)] border p-3 bg-surface">
      ...
      <div className="grid gap-2 text-sm text-foreground">
        ...
        <div className="flex items-center justify-between"><span>benÃ¶tigte Miete/mÂ²</span>
          <span className="tabular-nums">
