...
function page2(r: R, d: GewerbeReportData) {
  ...
  if (d.dscr != null) {
    ...
    r.kpi(ML, y, 36, 22, "DSCR-Wert", fmtNum(d.dscr), "NOI ÷ Kapitaldienst", "dark", C.yellow);
    const bw2 = CW * 0.62;
...
function page5(r: R, d: GewerbeReportData) {
  ...
  y = r.matrix(y, d);
  r.txt("Grün ab 1,20 (bankfähig)  ·  Orange ab 1,00 (grenzwertig)  ·  Rot unter 1,00 (kritisch)  ·  Gelb = Basisszenario",
