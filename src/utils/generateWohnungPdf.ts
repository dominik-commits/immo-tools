...
export function generateWohnungPdf(data: WohnungReportData): { bytes: Uint8Array; filename: string } {
  ...
  // DSCR KPI + Balken
  r.kpiTile(ML, y, 36, 22, "DSCR-Wert", dscrVal.toFixed(2), "NOI ÷ Kapitaldienst", "dark",
  ...
  r["text"]("Grün ab 1,20 (bankfähig)  ·  Orange ab 1,00 (grenzwertig)  ·  Rot unter 1,00 (kritisch)  ·  Gelb = Basisszenario",
