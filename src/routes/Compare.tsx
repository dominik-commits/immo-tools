...
import {
  ...
  Gauge, Banknote, TrendingUp, LineChart as LineIcon, Scale, Stars, Info, FileText
} from "lucide-react";
import {
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="w-48 shrink-0">
                        ...
                        <div className="mt-2 grid grid-cols-2 gap-2">
                          <button className="h-9 inline-flex items-center justify-center rounded-lg border bg-card hover:bg-surface" onClick={() => setSelectedId(s.id)} title="Hervorheben/Markieren">­</button>
    ...
    <div className="rounded-xl border p-2 bg-card shadow-soft">
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <div className="text-[11px] text-muted-foreground">”ž{label}”œ</div>
        </div>
      </div>
    </div>
  );
