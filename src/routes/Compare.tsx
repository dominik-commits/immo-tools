  ...
  return (
    <div style={{ background: BG_CARD, border: `1px solid ${BORDER}`, borderRadius: 16, overflow: "hidden" }}>
      <div style={{ padding: "16px 20px", borderBottom: `1px solid ${BORDER}` }}>
        ...
        <div style={{ fontSize: 12, color: TEXT_MUTED, marginTop: 2 }}>Gruen = bester Wert Â· Rot = schlechtester Wert</div>
      </div>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: 13, color: TEXT_MUTED, margin: "2px 0 0" }}>{objekte.length} Objekte Â· bis zu 5 möglich</p>
            </div>
          </div>
