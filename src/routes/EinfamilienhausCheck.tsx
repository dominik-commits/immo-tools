  ...
  return (
    <div style={{ position: "relative", width: size * 2, height: size * 2 }}>
      ...
      <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column" }}>
        ...
        <div style={{ fontSize: size * 0.22, color: "rgba(255,255,255,0.85)", marginTop: 2 }}>{label}</div>
      </div>
    </div>
  );
}
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 28, gap: 16 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: 12, color: "rgba(255,255,255,0.85)", margin: "3px 0 0" }}>Kaufpreis, Miete & Finanzierung eingeben – sofort sehen ob sich das EFH lohnt</p>
            </div>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{ background: "rgba(22,27,34,0.8)", border: "1px solid rgba(252,220,69,0.1)", borderRadius: 16, padding: 20 }}>
              ...
              <div style={{ marginTop: 12, padding: "10px 12px", background: "rgba(255,255,255,0.03)", borderRadius: 8, fontSize: 13, color: "rgba(255,255,255,0.85)" }}>
                Nebenkosten: <strong style={{ color: "rgba(255,255,255,0.85)" }}>{eur(nkBetrag)}</strong> · All-in: <strong style={{ color: "#FCDC45" }}>{eur(allIn)}</strong>
              </div>
            </div>
            ...
            <div style={{ background: "rgba(22,27,34,0.8)", border: "1px solid rgba(252,220,69,0.1)", borderRadius: 16, padding: 20 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 16 }}>
                <div>
                  ...
                  <div style={{ fontSize: 13, color: "rgba(255,255,255,0.85)", marginTop: 3 }}>Was bringt das EFH an Einnahmen?</div>
                </div>
                <span style={{ fontSize: 12, fontWeight: 600, padding: "3px 8px", borderRadius: 20, background: "rgba(252,220,69,0.1)", color: "#FCDC45", border: "1px solid rgba(252,220,69,0.2)" }}>EINGABE</span>
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              ...
              <div style={{ marginTop: 12, padding: "10px 12px", background: "rgba(255,255,255,0.03)", borderRadius: 8, fontSize: 13, color: "rgba(255,255,255,0.85)" }}>
                Effektivmiete: <strong style={{ color: "rgba(255,255,255,0.85)" }}>{eur(Math.round(mieteEffektiv))}/Jahr</strong> · NOI: <strong style={{ color: "#FCDC45" }}>{eur(Math.round(noiJahr))}/Jahr</strong>
              </div>
            </div>
            ...
            <div style={{ background: "rgba(22,27,34,0.8)", border: "1px solid rgba(252,220,69,0.1)", borderRadius: 16, padding: 20 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 16 }}>
                <div>
                  ...
                  <div style={{ fontSize: 13, color: "rgba(255,255,255,0.85)", marginTop: 3 }}>Optional — wie finanzierst du?</div>
                </div>
                <span style={{ fontSize: 12, fontWeight: 600, padding: "3px 8px", borderRadius: 20, background: "rgba(252,220,69,0.1)", color: "#FCDC45", border: "1px solid rgba(252,220,69,0.2)" }}>EINGABE</span>
              </div>
              ...
              {financingOn && (
                <div style={{ marginTop: 12, padding: "10px 12px", background: "rgba(255,255,255,0.03)", borderRadius: 8, fontSize: 13, color: "rgba(255,255,255,0.85)" }}>
                  Darlehen: <strong style={{ color: "rgba(255,255,255,0.85)" }}>{eur(Math.round(loan))}</strong> · Annuität: <strong style={{ color: "#FCDC45" }}>{eur(Math.round(annuityYear))}/Jahr</strong> ({eur(Math.round(annuityYear/12))}/Monat)
                </div>
              )}
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
              <div style={{ background: "rgba(22,27,34,0.8)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: 18 }}>
                ...
                {[
                  ...
                  { label: "NOI p.a.", value: eur(Math.round(noiJahr)), color: "rgba(255,255,255,0.85)" },
                  { label: "All-in Kaufpreis", value: eur(allIn), color: "rgba(255,255,255,0.85)" },
                ].map((row) => (
              ...
              <div style={{ background: "rgba(22,27,34,0.8)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: 18 }}>
                <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(255,255,255,0.8)", marginBottom: 12 }}>Kaufnebenkosten</div>
                {[
                  ...
                  <div key={row.label} style={{ display: "flex", justifyContent: "space-between", padding: "6px 0", borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
                    <span style={{ fontSize: 12, color: "rgba(255,255,255,0.85)" }}>{row.label}</span>
                    <span style={{ fontSize: 12, fontWeight: 500, color: "rgba(255,255,255,0.85)" }}>{eur(row.value)}</span>
                  </div>
                ))}
                <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 10px", marginTop: 6, background: "rgba(252,220,69,0.05)", borderRadius: 8, border: "1px solid rgba(252,220,69,0.12)" }}>
                  <span style={{ fontSize: 12, fontWeight: 600, color: "rgba(255,255,255,0.85)" }}>Summe NK</span>
    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div className="space-y-1">
          ...
          <div className="text-xs font-semibold uppercase tracking-widest" style={{ color: "rgba(255,255,255,0.85)" }}>
            {decisionLabelText}
          </div>
