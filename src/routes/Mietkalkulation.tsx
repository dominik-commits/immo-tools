...
function Card({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return <div className={`rounded-2xl border p-4 bg-card shadow-soft ${className}`}>{children}</div>;
}
function SliderRow({
  label,
  value,
    ...
    <div className="h-24 w-24 relative">
      ...
      <div className="absolute inset-0 grid place-items-center text-center">
        <div>
          ...
          <div className="text-[10px] text-muted-foreground mt-0.5">”ž{label}”œ</div>
        </div>
      </div>
    </div>
  );
    ...
    <div className="bg-gradient-to-b from-sky-50 to-white min-h-screen pb-28">
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">Ziel-Miete, Warmmiete, Break-even & Cashflow – klar, spielerisch, live.</p>
            </div>
          </div>
        ...
        <div className="rounded-2xl p-[1px] bg-gradient-to-br from-sky-300/50 via-indigo-200/50 to-emerald-200/50">
          <div className="rounded-2xl bg-card p-5 space-y-5">
            ...
            <div className="border rounded-xl p-3 bg-surface">
              <div className="flex items-center justify-between">
            ...
            <details>
              <summary className="cursor-pointer text-sm text-foreground">Projektion & Cap (optional)</summary>
        ...
        <section className="space-y-6">
          ...
          <Card>
            ...
            <p className="text-xs text-muted-foreground mt-2">Leerstand wirkt auf den Vermieter-Cashflow (effektive Mieten), nicht auf die vereinbarte Warmmiete.</p>
          </Card>
          ...
          <div className="rounded-2xl p-[1px] bg-gradient-to-br from-sky-300/70 via-emerald-300/70 to-indigo-300/70">
            <div className="rounded-2xl bg-card p-4">
              ...
              <p className="text-xs text-muted-foreground mt-2">Cap = Marktannahme. Modell-Wert ist Orientierung – Lage/Zustand prüfen.</p>
            </div>
          </div>
          ...
          <Card className="overflow-hidden">
            <div className="text-sm font-medium mb-1">Sensitivität (Î” Cashflow mtl., ±10%)</div>
            <div className="h-60">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart
                  data={sensitivity}
      ...
      <div className="fixed bottom-0 inset-x-0 z-30">
        <div className="max-w-3xl mx-auto px-3 pb-3">
          <div className="rounded-2xl shadow-lg ring-1 ring-gray-200 bg-card/95 backdrop-blur px-3 py-2">
