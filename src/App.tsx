...
// Wichtig: Der frühere WohnCheck heißt jetzt Eigentumswohnung (Default-Export)
import Eigentumswohnung from "./routes/Eigentumswohnung";

// MFH / Gewerbe / AfA / Finanzierung / Mietkalkulation – alle als Default-Export
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-6xl mx-auto px-4 py-6">
        <Routes>
          ...
          {/* Kompatibilität/Redirects von alten Routen */}
