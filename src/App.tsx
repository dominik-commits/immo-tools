    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <Suspense fallback={<LoadingScreen />}>
        <Routes>
          ...
          <Route path="/portfolio" element={<RequireLogin><AppShell><Portfolio /></AppShell></RequireLogin>} />
          <Route
            path="/gewerbe"
            element={
              <RequirePaid hasPaidPlan={hasPaidPlan}>
          ...
          <Route path="/extension" element={<RequireLogin><AppShell><Extension /></AppShell></RequireLogin>} />
